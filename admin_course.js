...
var AdminCourse = (function () {
  ...
  _state.courses.forEach(function (course) {
    ...
    html += '<div class="px-2 py-0.5">'
          ...
          + ' class="w-full text-left flex items-center gap-2 px-3 py-2.5 pr-12 rounded-xl text-sm font-semibold transition-all'
          + (isActive
          ...
          + '</svg>'
          + '<span>' + escapedCourse + '</span>'
          + '</button>'
          + '<button onclick="AdminCourse.confirmDeleteCourse(\'' + escapedCourse + '\')"'
          + ' title="교과 삭제"'
          + ' class="absolute right-1 top-1/2 -translate-y-1/2 flex items-center justify-center px-2 py-1 rounded-lg text-xs font-bold text-red-400 hover:text-white hover:bg-red-400 border border-red-200 hover:border-red-400 transition-all">'
          + '삭제'
          + '</button>'
          + '</div>'
